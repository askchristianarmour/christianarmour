    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#faf5e8] text-[#8a6d2b]">
            <Gift size={22} />
          </div>
          <div>
            <h2 className="text-xl font-bold text-slate-900">Invite & Earn Rewards</h2>
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-100 bg-slate-50 px-4 py-3">
            ...
            <p className="mt-1 font-serif text-3xl text-slate-900">{referrals.length}</p>
          </div>
          <div className="rounded-xl border border-slate-100 bg-slate-50 px-4 py-3">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">
              Your code
            </p>
            <p className="mt-1 font-mono text-lg font-semibold tracking-wider text-slate-900">
              {wallet?.referral_code ?? '••••••••'}
            </p>
          </div>
        </div>
        ...
        <div className="mt-5 space-y-2">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            <input
              readOnly
              value={inviteUrl}
              className="min-w-0 flex-1 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-700"
            />
            <button
              type="button"
              onClick={copyInvite}
              className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50"
            >
            ...
            <button
              type="button"
              onClick={shareInvite}
              className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-slate-800"
            >
              <Share2 size={16} />
              Share
            </button>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-900">Badges & recognition</h3>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {earned && (
                    <span className="ml-auto rounded-full bg-green-100 px-2 py-0.5 text-[10px] font-bold uppercase text-green-700">
                      Earned
                    </span>
                  )}
                </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-slate-900">Successful invites</h3>
        </div>
        {referrals.length === 0 ? (
